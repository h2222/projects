...
from config import boddy, prem_path, vocab_path, url_sort, params_sort_027, h_cls, url_cls, params_cls, header_cls, h_sort
...
def test():
    ...
    if request.method=='POST':
        ...
        # 增加两条协程
        coroutine_1 = models(url_sort, params_sort_027, None)
        coroutine_2 = models(url_cls, params_cls, header_cls)
        # 定义任务
        tasks = [
        ...
        if sim >= 0.8:
            ...
            outype_sort = h_sort[outnode_sort]
