...
def serving_input_receiver_fn():
    ...
    receiver_tensors = {
        #
        "user_id": tf.placeholder(tf.string, [None, 1], name="user_id"),
        ...
        #
        "good_id": tf.placeholder(tf.int64, [None, 1], name="good_id"),
        ...
        "rp_l": tf.placeholder(tf.int64, [None, 1], name="rp_l"),
        "mp_l": tf.placeholder(tf.int64, [None, 1], name="mp_l"),
        ...
        "counter_price": tf.placeholder(tf.float32, [None, 1], name="counter_price"),
        "market_price": tf.placeholder(tf.float32, [None, 1], name="market_price"),
        #
        ...
        "stat_data": tf.placeholder(tf.float32, [None, len(int_stat_basic_columns)], name="stat_data"),
    }
