...
class BaseParams():
    ...
    def get_data_info(self, problem_list, base):
        ...
        if os.path.exists(json_path):
            ...
            #self.num_classes = tf.constant(3)
        ...
        if not self.is_serve:
            ...
            for problem in problem_list:
                if problem not in self.data_num_dict or self.multiprocess:
                    ...
                    #print('data_num', self.data_num_dict[problem])
                    #for index, i in enumerate(list(self.read_data_fn[problem](self, 'train'))):
                    #    print(index)
                    #    print(i)
...
class DynamicBatchSizeParams(BaseParams):
    def __init__(self):
        ...
        #self.bucket_batch_sizes = [1, 1, 1, 1]
