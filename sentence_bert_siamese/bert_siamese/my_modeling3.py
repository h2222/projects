...
class BertConfig(object):
    ...
    """
        ...
        self.num_hidden_layers = num_hidden_layers  # Transformer encoder中的隐藏层数
        self.num_attention_heads = num_attention_heads  # multi-head attention 的head数
        self.hidden_act = hidden_act  # encoder的“中间”隐层神经元数（例如feed-forward layer）
        self.intermediate_size = intermediate_size  # 隐藏层激活函数
        self.hidden_dropout_prob = hidden_dropout_prob  # 隐层dropout率
...
def embedding_postprocessor(
  ...
  """
    ...
    if use_position_embeddings:
        ...
        )  # 确保句子长度小于 max_position_embeddings
        with tf.control_dependencies([assert_op]):
            ...
            position_embeddings = tf.slice(
                ...
                [0, 0],
                [seq_length, -1],  # 从 embedding 矩阵中取出 seg_length 长度
            )
            ...
            )  # 通过 broadcasting 加到每个 batch_size 上
