...
import csv
import os
import my_modeling3 as my_modeling
import optimization
import tokenization
...
def create_model(
    ...
    print("input_ids" * 5, input_ids)
    print("input_mask" * 5, input_mask)
    print("segment_ids" * 5, segment_ids)
    ...
    with tf.variable_scope("loss"):
        ...
        output_weights = tf.get_variable(
            ...
            initializer=my_modeling.create_initializer(bert_config.initializer_range),
        )
        ...
        logits = tf.matmul(layer2, output_weights, transpose_b=True)
        ...
        with tf.gfile.GFile(output_predict_file, "w") as writer:
            ...
            for (i, prediction) in enumerate(result):
                ...
                if i >= num_actual_predict_examples:
                    break
                if i % 10000 == 0:
                    print("Predicting %d of %d" % (i + 1, num_actual_predict_examples))
